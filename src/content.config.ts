...
const techStack = defineCollection({
  loader: file("src/content/tech-stack.json"),
  schema: z.object({
    id: z.number(),
    text: z.string(),
    link: z.string().url(),
...
const langStack = defineCollection({
  loader: file("src/content/lang-stack.json"),
  schema: z.object({
    id: z.number(),
    text: z.string(),
    level: z.string()
...
export const collections = { tags, posts, projects, other, quickInfo, socials, workExperience, techStack, langStack };