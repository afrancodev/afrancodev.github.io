...
public static <T> T measure(String label, Supplier<T> task) {
    ...
    try {
        ...
        System.out.printf("%s took %.3f ms%n", label, durationMs);
    }
}
...
public static void main(String[] args) {
    ...
    measure(String.format("Linear Search for %d", target), () -> linearSearch(arrayList, target));

    measure(String.format("Binary Search for %d", target),
...
Linear Search for 99305144                   : 298,046900 ms
...
Linear Search for 79921793                   : 197,271300 ms
...
Linear Search for 12395033                   : 42,172800 ms
...
The code can be found in [here](https://github.com/afrancodev/blog-code-examples/blob/main/src/com/afranco/main/algo/search/BinarySearch.java).
